...
frame2.pack()
main_data_window(
    f'http://newsapi.org/v2/top-headlines?country=in&apiKey={YOUR_API_KEY}', frame2)
# frame3 or tab3
frame3 = tk.Frame(my_notebook)
frame3.pack()
main_data_window(
    f'http://newsapi.org/v2/top-headlines?country=in&category=business&apiKey={YOUR_API_KEY}', frame3)
# frame4 or tab4
frame4 = tk.Frame(my_notebook)
frame4.pack()
main_data_window(
    f'http://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey={YOUR_API_KEY}', frame4)
# frame5 or tab5
frame5 = tk.Frame(my_notebook)
frame5.pack()
main_data_window(
    f'http://newsapi.org/v2/top-headlines?country=in&category=health&apiKey={YOUR_API_KEY}', frame5)
# frame6 or tab6
frame6 = tk.Frame(my_notebook)
frame6.pack()
main_data_window(
    f'http://newsapi.org/v2/top-headlines?country=in&category=science&apiKey={YOUR_API_KEY}', frame6)
# frame7 or tab7
frame7 = tk.Frame(my_notebook)
frame7.pack()
main_data_window(
    f'http://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey={YOUR_API_KEY}', frame7)
# frame8 or tab8
frame8 = tk.Frame(my_notebook)
frame8.pack()
main_data_window(
    f'http://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey={YOUR_API_KEY}', frame8)
